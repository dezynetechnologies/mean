...
module.exports = function (app) {
    ...
    app.route('/users/profiles').get(users.list);
    app.route('/users/profiles').post(users.create);

    app.route('/users/profiles/:userId').get(users.read);
    app.route('/users/profiles/:userId').put(users.updateCompleteProfile);
    app.route('/users/profiles/:userId').delete(users.delete);
